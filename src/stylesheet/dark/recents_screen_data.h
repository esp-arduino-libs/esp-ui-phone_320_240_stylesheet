...
LV_IMG_DECLARE(esp_ui_phone_[T_WIDTH]_[T_HEIGHT]_recents_screen_image_trash);

#define ESP_UI_PHONE_[T_WIDTH]_[T_HEIGHT]_DARK_RECENTS_SCREEN_SNAPSHOT_DATA()   \
    {                                                              \
...
#define ESP_UI_PHONE_[T_WIDTH]_[T_HEIGHT]_DARK_RECENTS_SCREEN_DATA()                           \
    {                                                                             \
        .main = {                                                                 \
            .y_start = 0,                                                         \
        ...
        .snapshot_table = {                                                       \
            ...
            .snapshot = ESP_UI_PHONE_[T_WIDTH]_[T_HEIGHT]_DARK_RECENTS_SCREEN_SNAPSHOT_DATA(), \
        },                                                                        \
        .trash_icon = {                                                           \
            .default_size = ESP_UI_STYLE_SIZE_SQUARE(48),                         \
            .press_size = ESP_UI_STYLE_SIZE_SQUARE(43),                           \
            .image = ESP_UI_STYLE_IMAGE(&esp_ui_phone_[T_WIDTH]_[T_HEIGHT]_recents_screen_image_trash),\
        },                                                                        \
        .flags = {                                                                \
            .enable_memory = 1,                                                   \
